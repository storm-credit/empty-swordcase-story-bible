# AGENTS.md — 《유물을 먹는 파천마검》 제작 오케스트라 v1.2
...
- 담운 근접 3인칭
- 화당 본문은 줄바꿈 제외 최소 4,500자
- 글자 수 상한은 없으며 회차 사건과 독자 경험이 자연스럽게 완결되는 분량을 따른다.
- 분량을 줄이기 위해 핵심 사건·감정·공간·비용을 생략하지 않고, 분량을 늘리기 위한 반복 설명도 금지한다.
- 첫 10% 안에 직전 훅 행동 회수
- 6~9개 장면 비트
